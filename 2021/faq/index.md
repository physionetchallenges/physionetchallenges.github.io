...
We run your training code on Google Cloud using 4 vCPUs, 32 GB RAM, and an optional NVIDIA T4 Tensor Core GPU. If your MATLAB submission requires a GPU, the runtime docker images are built on base images using NVIDIA CUDA 10.0-devel-CentOS 7. Your training code has a 36 hour time limit using the GPU and a 72 hours time limit without using a GPU.
