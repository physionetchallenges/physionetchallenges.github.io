...
We will run your training code on Google Cloud using 4 vCPUs, 32 GB RAM, and an optional NVIDIA T4 Tensor Core GPU. Your training code has a 72 hour time limit without a GPU and a 36 hour time limit with a GPU.
