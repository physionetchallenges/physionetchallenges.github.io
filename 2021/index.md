...
- To refer to the 2021 Challenge, please cite the following two articles: 
   ...
   2. [Reyna MA, Sadr N, Perez Alday EA, Gu Annie, Shah AJ, Robichaux C, Rad AB, Elola A, Seyedi S, Ansari S, Ghanbari H, Li Q, Sharma A, Clifford GD. Issues in the automated classification of multilead ECGs using heterogeneous labels and populations. Physiol. Meas. 2022](papers/2021ChallengePaperPMEA.pdf). 
...
6. Georgia 12-Lead ECG Challenge Database, 10,344 recordings: [link](https://storage.cloud.google.com/physionetchallenge2021-public-datasets/WFDB_Ga.tar.gz); MD5 hash: `47085dd62baca5ace4041025d6910b13`; [(headers only)](https://storage.cloud.google.com/physionetchallenge2021-public-datasets/Ga-Headers.tar.gz)
