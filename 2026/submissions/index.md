...
# <a name="submission-instructions-and-form"></a> Submission instructions for the 2026 Challenge
...
Similarly to [last year's Challenge](../../2025/), teams must submit the full code for their models. To help, we have implemented an example entry in Python. We encourage teams to use this example as a template for their code.
...
6. Submit your entry using a form; check the left panel.
...
1. You can use our [Python example code](https://github.com/physionetchallenges/python-example-2026.git) as a template. Please clone or download this repository, replace our code with your code, and push or upload the files to your repository.
...
Please see the [George B. Moody PhysioNet Challenge 2026 webpage](../) for more details. Please post questions and concerns on the [Challenge discussion forum](https://groups.google.com/forum/#!forum/physionet-challenges).
