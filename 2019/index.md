...
$$U(s, t) = \Bigg\{ U_{TP}(s,t), positive prediction at time _t_ for sepsis patient _s_, \ & U_{FN}(s,t), negative prediction at time _t_ for sepsis patient _s_, \ & U_{FP}(s,t), positive prediction at time _t_ for non-sepsis patient _s_, \ & U_{TN}(s,t), negative prediction at time _t_ for non-sepsis patient _s_.$$
...
![](/files/challenge-2019/1.0.0/utility_sepsis_diagram.svg) ![](/files/challenge-2019/1.0.0/utility_nonsepsis_diagram.svg)
